...
public class MainController implements Initializable {
	...
	@FXML
	private TableView<BoardVO> tableView_boardList;
	@FXML
	...
	private BoardSvc svc = new BoardSvcImpl();
	...
	public void setTableData(String boardTitle, String boardWriter) {
		...
		// 게시판 리스트를 불러옴
		List<BoardVO> list = svc.selectBoardList(boardTitle, boardWriter, boardType);
		// 테이블뷰에 바인드 될 옵저버블리스트
